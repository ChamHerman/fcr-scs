...
export const CompensationReportList: React.FC = () => {
  ...
  const handleCreateReport = () => {
    if (isGovAdmin) {
      alert("Government Administrators cannot create compensation reports. Reports must be generated by Government Officers.");
      return;
    }
    if (!isOfficer && !isSysAdmin) {
      alert("Only Government Officers can create compensation reports.");
      return;
    }
