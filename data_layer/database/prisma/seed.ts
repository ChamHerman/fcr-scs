...
async function main() {
  ...
  const initialAlertRules = [
    ...
    },
    {
      ...
      triggerEmail: false,
      urgencyLevel: AlertUrgency.MEDIUM,
      targetRole: 'GOVERNMENT_ADMINISTRATOR,GOVERNMENT_OFFICER',
      isEnabled: true,
      createdById: defaultAdmin.userId,
    },
    {
    ...
    // ── AI Valuation ─────────────────────────────────────────────────────────
    {
      ruleName: 'AI Model Retrained Successfully',
      description: 'Notify System Administrators when the AI valuation model has been successfully retrained with a new dataset.',
    ...
    {
      ruleName: 'AI Model Retraining Failed',
      description: 'Alert System Administrators immediately when AI model retraining fails or the Python sidecar is offline.',
    ...
    {
      ruleName: 'AI Model Activated — Notify Land Valuers',
      description: 'Notify all Land Valuers when a new AI valuation model has been activated and is live for use.',
    ...
    {
      ruleName: 'AI Model Activated — Notify Admins',
      description: 'Notify System Administrators when a new AI valuation model has been promoted to active production use.',
      activityType: 'AI_MODEL_ACTIVATED',
      moduleName: 'AI_VALUATION',
      minSeverity: 'INFO',
      triggerInApp: true,
    ...
    // ── Reporting & Analytics ────────────────────────────────────────────────
    {
      ruleName: 'Official Report Generated or Exported',
      description: 'Notify Government Administrators and System Administrators when an official system report is generated or exported as PDF.',
      ...
      triggerEmail: false,
      urgencyLevel: AlertUrgency.LOW,
      targetRole: 'GOVERNMENT_ADMINISTRATOR,SYSTEM_ADMINISTRATOR',
      isEnabled: true,
      createdById: defaultAdmin.userId,
    },
    {
      ruleName: 'Official Report Exported as PDF',
      description: 'Notify Government Administrators and System Administrators when an official system report is exported as PDF.',
    ...
    // ── Payment: Bank Details → Member Notifications ─────────────────────────
    {
      ruleName: 'Member Bank Details Submitted → Notify Government Admin',
      description: 'Notify Government Administrators when an affected community member submits their bank details for disbursement.',
    ...
    {
      ruleName: 'Admin Requests Updated Bank Details → Notify Member',
      description: 'Notify the affected beneficiary when a Government Administrator requests updated bank account details.',
    ...
    // ── Payment: Workflow → Government Admin ──────────────────────────────────
    {
      ruleName: 'Transfer Initiated — Awaiting Co-Signature',
      description: 'Notify Government Administrators when a disbursement transfer is initiated and requires multi-signature co-authorisation.',
    ...
    {
      ruleName: 'Transfer Rejected → Notify Member',
      description: 'Notify affected beneficiary when a disbursement transfer is rejected by a Government Administrator.',
    ...
    {
      ruleName: 'Transfer Cancelled → Notify Member',
      description: 'Notify affected beneficiary when a disbursement transfer is permanently cancelled.',
    ...
    // ── Payment: Bank Clearance → Member Notifications ───────────────────────
    {
      ruleName: 'Bank Clearance Approved → Notify Member',
      description: 'Notify affected beneficiary when the bank clearance is approved and they must confirm receipt of funds within 7 days.',
    ...
    {
      ruleName: 'Bank Clearance Approved → Notify Government Admin',
      description: 'Notify Government Administrators when bank clearance is approved.',
      activityType: 'BANK_TRANSFER_APPROVED',
      moduleName: 'PAYMENT',
      minSeverity: 'CRITICAL',
      triggerInApp: true,
    ...
    {
      ruleName: 'Bank Clearance Rejected → Notify Member',
      description: 'Notify affected beneficiary when bank transfer is rejected by the commercial bank gateway.',
    ...
    {
      ruleName: 'Bank Clearance Rejected → Notify Government Admin',
      description: 'Notify Government Administrators when bank transfer is rejected by the commercial bank gateway.',
      activityType: 'BANK_TRANSFER_REJECTED',
      moduleName: 'PAYMENT',
      minSeverity: 'CRITICAL',
      triggerInApp: true,
    ...
    {
      ruleName: 'Transfer Rescheduled → Notify Member',
      description: 'Notify affected beneficiary when a disbursement transfer is rescheduled to the next business day.',
    ...
    {
      ruleName: 'Payment Receipt Confirmed → Notify Government Admin (M2 Ready)',
      description: 'Notify Government Administrators when a member confirms receipt of funds. Payment is now PAID and eligible for Milestone 2 notarization.',
    ...
    // ── Payment: Milestone 2 Notarized → Notify Member ────────────────────────
    {
      ruleName: 'Milestone 2 Notarized → Notify Member',
      description: 'Notify affected community member when Milestone 2 (Settlement) is notarized on-chain, completing the land acquisition.',
      activityType: 'BLOCKCHAIN_MILESTONE2_NOTARIZED',
    ...
    // ── Payment: Dispute → Government Admin ───────────────────────────────────
    {
      ruleName: 'Payment Dispute Filed → Notify Government Admin',
      description: 'Notify Government Administrators immediately when a beneficiary files a payment dispute with supporting bank documentation.',
    ...
    {
      ruleName: 'Dispute Resolved → Notify Member',
      description: 'Notify affected beneficiary when a Government Administrator resolves their payment dispute.',
      activityType: 'PAYMENT_DISPUTE_RESOLVED',
      moduleName: 'PAYMENT',
      minSeverity: 'CRITICAL',
      triggerInApp: true,
      triggerEmail: true,
    ...
    {
      ruleName: 'Dispute — New Bank Details Requested → Notify Member',
      description: 'Notify affected beneficiary when a payment dispute is resolved by requesting updated bank account details.',
      activityType: 'PAYMENT_DISPUTE_DETAILS_REQUESTED',
      moduleName: 'PAYMENT',
      minSeverity: 'CRITICAL',
      triggerInApp: true,
      triggerEmail: true,
    ...
    // ── Milestone 1 Notarized → Notify Member ─────────────────────────────────
    {
      ruleName: 'Milestone 1 Notarized → Notify Member',
      description: 'Notify affected community member when Milestone 1 (Award) is notarized on-chain. Bank details submission is now required.',
      activityType: 'BLOCKCHAIN_MILESTONE1_NOTARIZED',
      moduleName: 'BLOCKCHAIN',
      minSeverity: 'INFO',
      triggerInApp: true,
      triggerEmail: true,
